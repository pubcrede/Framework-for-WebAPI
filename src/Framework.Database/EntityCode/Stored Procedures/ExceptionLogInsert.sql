CREATE PROCEDURE [EntityCode].[ExceptionLogInsert]
...
AS	
	...
	INSERT INTO [Activity].[ExceptionLog] ([Message], [CreatedActivityID], [CustomMessage])
		   SELECT ERROR_MESSAGE() AS [Message], @ActivityContextID As [CreatedActivityID], IsNull(@CustomMessage, '') As [CustomMessage]
