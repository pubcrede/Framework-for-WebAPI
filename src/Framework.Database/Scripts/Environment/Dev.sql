...
WHEN MATCHED THEN 
	UPDATE SET [FirstName] = Source.[FirstName], [MiddleName] = Source.[MiddleName], [CustomerTypeID] = CT.[CustomerTypeID],
		[LastName] = Source.[LastName], [BirthDate] = Source.[BirthDate], [ModifiedActivityID] = @ActivityContextID_Dev
-- Insert 
WHEN NOT MATCHED BY TARGET THEN 
	INSERT ([CustomerKey], [FirstName], [MiddleName], [LastName], [BirthDate], [CustomerTypeID], [CreatedActivityID], [ModifiedActivityID]) 
		Values (Source.[CustomerKey], Source.[FirstName], Source.[MiddleName], Source.[LastName], Source.[BirthDate], CT.[CustomerTypeID], @ActivityContextID_Dev, @ActivityContextID_Dev)
;
