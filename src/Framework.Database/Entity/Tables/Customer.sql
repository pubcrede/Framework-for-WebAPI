CREATE TABLE [Entity].[Customer] (
	...
	CONSTRAINT [FK_Customer_CreatedActivity] FOREIGN KEY ([CreatedActivityID]) REFERENCES [Activity].[ActivityContext] ([ActivityContextID]),
	CONSTRAINT [FK_Customer_ModifiedActivity] FOREIGN KEY ([ModifiedActivityID]) REFERENCES [Activity].[ActivityContext] ([ActivityContextID]),
