CREATE TABLE [Identity].[AspNetUsers] (
	...
	[CreatedActivityID]		INT				NOT NULL CONSTRAINT [DF_AspNetUsers_CreatedActivity] DEFAULT ('-1'),
	[ModifiedActivityID]	INT				NOT NULL CONSTRAINT [DF_AspNetUsers_ModifiedActivity] DEFAULT ('-1'),
